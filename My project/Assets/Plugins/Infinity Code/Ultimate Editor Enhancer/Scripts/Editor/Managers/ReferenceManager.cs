        ...
        private static void Load()
        {
            ...
            try
            {
                ...
                if (_instance == null)
                {
                    ...
                    string dirPath = System.IO.Path.Combine(Application.dataPath, "..", assetPath);
                    System.IO.DirectoryInfo dirInfo = new System.IO.DirectoryInfo(System.IO.Path.GetDirectoryName(dirPath));
